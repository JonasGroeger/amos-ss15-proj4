...
public class ZipGenerator {
	public void generate(OutputStream out, Locale locale, float height, Employee employee, int fontSize, String Password) throws ZipException, NoSuchMessageException, IOException, COSVisitorException, CloneNotSupportedException {
